...
import thePaladin.patches.relics.BottledPlaceholderField;
import thePaladin.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static thePaladin.DefaultMod.makeRelicOutlinePath;
import static thePaladin.DefaultMod.makeRelicPath;
